...
\receita{Arroz japonês\label{rec:arroz_japones}}{
  \begin{itemize}
...
\receita{Onigiri}{
  ...
  \item Molhar a mão na água de torneira e passar um pouco de sal
...
\receita{Naan}{
  ...
  \item 2 g de sal
  \item 2 g de açúcar
  \item 160 g de iogurte grego integral
  \item 22 g de azeite
...
\receita{Batata rosti}{
  \begin{itemize}
  \item 300 g de batata
  \item Queijo
  \item Óleo para untar
  \item Sal
  \end{itemize}
}{
  \begin{enumerate}
  \item Ralar a batata, espremer para tirar o máximo da água dela. Colocar um
    pouco de sal.
  \item Colocar metade da batata numa frigideira quente antiaderente untada.
    Ficar com $\pm$ 1 cm de altura.
  \item Colocar as fatias de queijo
  \item Colocar a outra metade da batata, ficar com $\pm$ 1 cm de altura
  \item Virar quando começar a soltar o fundo, algo como 10 minutos
  \end{enumerate}
}
