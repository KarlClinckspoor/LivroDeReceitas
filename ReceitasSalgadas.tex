...
\receita{Kebab de frigideira\checkmark}{
  ...
  \textbf{Nota:} Receita inspirada pelo vídeo \texttt{https://youtu.be/mVHNKkpYsMI}.
	...
	\begin{enumerate}
      ...
      \end{itemize}
		\item Adicionar sal (5 giradas ida e volta), pimenta do reino (2 pitadas), pimenta
		      síria, e misturar bem
		\item Colocar o óleo na frigideira e cobrir tudo
