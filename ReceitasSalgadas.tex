...
\receita{Batata rosti/Hashbrowns \checkmark}{
	\begin{itemize}
...
\receita{Espaguete a carbonara\checkmark}{
	\begin{itemize}
...
\receita{Carne coreana}{
	\begin{itemize}
		...
		\item 1 colher de sopa de açúcar mascavo
		\item Pimenta do reino
		\item 2 dentes de alho espremidos
	\end{itemize}
}{
	\begin{enumerate}
		\item Cortar a carne em tiras ou cubos
		\item Cortar a cebola em pétalas
